    ...
    Public Sub DrawShadow(theSpriteBatch As SpriteBatch)
        If CastShadows AndAlso Position.Z = 0 Then
            ...
            Else
                ...
                theSpriteBatch.Draw(ShadowTexture, New Rectangle(CInt(BoundingBox.Right - BoundingBox.Width / 2), CInt(BoundingBox.Top - BoundingBox.Height / 2), BlockWidth, diagonal), Nothing, Color.White, ToRad(45),
